...
#line 13 "main.c"
#line 14 "main.c"
#line 1 "E:\\D\\DATA\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\string.h"
...
#line 38 "E:\\D\\DATA\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\string.h"
    ...
    typedef unsigned int size_t;    
#line 54 "E:\\D\\DATA\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\string.h"
...
#line 193 "E:\\D\\DATA\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\string.h"
...
#line 209 "E:\\D\\DATA\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\string.h"
...
#line 232 "E:\\D\\DATA\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\string.h"
...
#line 247 "E:\\D\\DATA\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\string.h"
...
#line 270 "E:\\D\\DATA\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\string.h"
...
#line 502 "E:\\D\\DATA\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\string.h"
...
#line 15 "main.c"
#line 1 ".\\Library\\StdDriver\\inc\\uart_user.h"
#line 2 ".\\Library\\StdDriver\\inc\\uart_user.h"
#line 3 ".\\Library\\StdDriver\\inc\\uart_user.h"
#line 4 ".\\Library\\StdDriver\\inc\\uart_user.h"

extern char recData[1024];
...
#line 16 "main.c"
#line 1 ".\\Library\\StdDriver\\inc\\timer_user.h"
#line 2 ".\\Library\\StdDriver\\inc\\timer_user.h"
void Delay_ms(int ms);
#line 17 "main.c"
#line 1 ".\\Library\\StdDriver\\inc\\esp8266.h"
#line 2 ".\\Library\\StdDriver\\inc\\esp8266.h"
#line 1 ".\\Library\\StdDriver\\inc\\uart_user.h"
#line 2 ".\\Library\\StdDriver\\inc\\uart_user.h"
#line 3 ".\\Library\\StdDriver\\inc\\uart_user.h"
#line 4 ".\\Library\\StdDriver\\inc\\uart_user.h"
...
void UART1_Init(void);
void UART1_IRQHandler(void);
#line 3 ".\\Library\\StdDriver\\inc\\esp8266.h"
#line 1 ".\\Library\\StdDriver\\inc\\timer_user.h"
#line 2 ".\\Library\\StdDriver\\inc\\timer_user.h"
void Delay_ms(int ms);
#line 4 ".\\Library\\StdDriver\\inc\\esp8266.h"
#line 5 ".\\Library\\StdDriver\\inc\\esp8266.h"
...
int main(void)
{
  ...
  Wifi_Connect("ABCD","ABC1234567");
	...
	while(1){
			...
			if((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((1)<<2))))==0)
			{ 
				
				if((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((0)<<2)))) ==0){
					while((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((0)<<2))))==0);
					Delay_ms(600);
					Send_String(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)),"Phim Ket Noi\n");
					
					Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"AT+CIPSEND=19\r\n");
					Check_Data(recData,"OK","ERROR");
					XoaBuffer(recData);
					
					Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"connect_from_remote");
					Check_Data(recData,"OK","ERROR");
					XoaBuffer(recData);
					while(1){
						if (strstr(recData,"OK"))
						{
							Send_String(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)),"OK_connect\n");
							break;
						}
					}
					XoaBuffer(recData);
							
					Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"AT+CIPSEND=5\r\n");
					
					Check_Data(recData,"OK","ERROR");
					Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"ready");
					XoaBuffer(recData);
					while(1){
						if (strstr(recData,"wait_to_pair"))
						{
							Send_String(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)),"OK_wait\n");
							break;
						}
					}
					XoaBuffer(recData);			
					Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"AT+CIPSEND=7\r\n");
					Check_Data(recData,"OK","ERROR");
					XoaBuffer(recData);
					Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"waiting\r\n");
					
					while(1){
						if (strstr(recData,"OK"))
						{
							Send_String(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)),"OK_waiting\n");
							break;
						}
					}
					XoaBuffer(recData);
					while(1){
						...
						{
							Send_String(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)),"ok_pair\n");
							break;
						}
					}
					XoaBuffer(recData);
					Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"AT+CIPSEND=6\r\n");
			
					Check_Data(recData,"OK","ERROR");
					XoaBuffer(recData);
					Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"paired");
					Check_Data(recData,"OK","ERROR");
					XoaBuffer(recData);
					while(1){
						if (strstr(recData,"OK"))
			...
			if((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((1)<<2))))==1)
			{
				...
				if((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((4)<<2)))) ==0){
					while((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((4)<<2))))==0);
					Delay_ms(200);
					Send_String(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)),"Phim S\n");
					Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"AT+CIPSEND=4\r\n");
					Check_Data(recData,"OK","ERROR");
					XoaBuffer(recData);
					Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"DOWN");
					Check_Data(recData,"OK","ERROR");
					XoaBuffer(recData);
				...
				if((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((5)<<2)))) ==0){
					while((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((5)<<2))))==0);
					Send_String(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)),"Phim W\n");
					Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"AT+CIPSEND=2\r\n");
					Check_Data(recData,"OK","ERROR");
					XoaBuffer(recData);
					Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"UP");
					Check_Data(recData,"OK","ERROR");
					XoaBuffer(recData);
				...
				if((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((11)<<2)))) ==0){
					while((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((11)<<2))))==0);
				
					Send_String(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)),"Phim A\n");
					Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"AT+CIPSEND=4\r\n");
					Check_Data(recData,"OK","ERROR");
					XoaBuffer(recData);
					Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"LEFT");
					Check_Data(recData,"OK","ERROR");
					XoaBuffer(recData);
				...
				if((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((15)<<2)))) ==0){
					while((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((15)<<2))))==0);
					
					Send_String(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)),"Phim D\n");
					Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"AT+CIPSEND=5\r\n");
					
					Check_Data(recData,"OK","ERROR");
					XoaBuffer(recData);
					Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"RIGHT");
					Check_Data(recData,"OK","ERROR");
					XoaBuffer(recData);
				...
				if((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((14)<<2))))==0){
					while((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((14)<<2))))==0);
				
					Send_String(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)),"Phim so1\n");
					Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"AT+CIPSEND=6\r\n");
					Check_Data(recData,"OK","ERROR");
					XoaBuffer(recData);
					Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"ROTATE");
					Check_Data(recData,"OK","ERROR");
					XoaBuffer(recData);
				...
				if((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(1))) + ((11)<<2))))==0){
					...
					Send_String(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)),"Phim so2\n");
					Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"AT+CIPSEND=1\r\n");
					Check_Data(recData,"OK","ERROR");
					XoaBuffer(recData);
					Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"2");
					Check_Data(recData,"OK","ERROR");
					XoaBuffer(recData);
				...
				if((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((12)<<2))))==0){
					while((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((12)<<2))))==0);
				
					Send_String(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)),"Phim so3\n");
					Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"AT+CIPSEND=1\r\n");
					Check_Data(recData,"OK","ERROR");
					XoaBuffer(recData);
					Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"3");
					Check_Data(recData,"OK","ERROR");
					XoaBuffer(recData);
				...
				if((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((13)<<2))))==0){
					while((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((13)<<2))))==0);
			
					Send_String(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)),"Phim so4\n");
					Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"AT+CIPSEND=3\r\n");
					Check_Data(recData,"OK","ERROR");
					XoaBuffer(recData);
					Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"PUT");
					Check_Data(recData,"OK","ERROR");
					XoaBuffer(recData);
				}
				 Check_Rung(recData);
...
void OpenKeyPad(void)
{
  ...
  GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) )), 0x00008000, 0x3UL);
	...
	GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040)), 0x00000800, 0x3UL);
	  ...
	  if (strstr(recData,"Rung1"))
		{
			RungLienTuc();
			XoaBuffer(recData);
			Send_String(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)),"Rung Lien Tuc\n");
		}
		else if(strstr(recData,"Rung2"))
		{
			RungDutKhoang();
			XoaBuffer(recData);
			Send_String(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)),"Rung Dut Khoang\n");
		}
}
