...
void Check_Data(char *recData,char *OK,char *Error)
{
	while(1)
	{
		...
		{
			Send_String(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)),"OK\n");
			break;
		}
		else if (strstr(recData,Error))
		{
			Send_String(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)),"FAIL\n");
		  while(1);
		}
	}
}
void Wifi_Check()
{
	Send_String(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)),"Send AT: ");
	Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"AT\r\n");
	Check_Data(recData,"OK","ERROR");
	XoaBuffer(recData);
}
void Wifi_Reset()
{
	Send_String(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)),"Send AT+RST: ");
	Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"AT+RST\r\n");
	Check_Data(recData,"ready","ERROR");
	XoaBuffer(recData);
}
void Wifi_Connect(char *id,char *pass)
{
	Send_String(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)),"Connect to router: ");
	Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"AT+CWJAP=\"");
	Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),id);
	Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"\",\"");
	Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),pass);
	Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"\"\r\n");
...
void Wifi_ConnectSever(void)
{
	Send_String(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)),"Connect to sever: ");
	Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"AT+CWMODE=1\r\n");
	Check_Data(recData,"OK","ERROR");
	XoaBuffer(recData);
	Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"AT+CIPMUX=0\r\n");
	Check_Data(recData,"OK","ERROR");
	XoaBuffer(recData);
	
	Send_String(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),"AT+CIPSTART=\"TCP\",\"htn.ddns.net\",9000\r\n");
