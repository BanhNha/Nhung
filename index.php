...
<body>
	...
	<h2>Login here</h2>
		<form name="login" action="index.php" method="post">
			<input type="text" Name="Username" placeholder="USERS" required="">
			...
			<div class="contact-w3-agileits">
				...
				<form action="index.php" method="post" onsubmit="return validateForm();">
				        <div class="form-sub-w3ls">
							<input id="Name"  placeholder="Name" Name="Name" type="text"  pattern="[A-Za-z]+[ ]+[A-Za-z]${5,}" 
							title="Tối thiểu 5 ký tự, và không có chứa các ký tự đặt biệt và ký tự số."  required="">
							<div class="icon-agile">
								<i class="fa fa-user" aria-hidden="true"></i>
							</div>
						</div>
						<div class="form-sub-w3ls">
							<input id="Username" placeholder="UserName" Name="Username" type="text"  pattern="[A-Za-z0-9]{5,}" 
							title="Tối thiểu 5 ký tự, và không có chứa các ký tự đặt biệt."  required="">
							<div class="icon-agile">
								<i class="fa fa-user" aria-hidden="true"></i>
							</div>
						</div>
						...
						<div class="form-sub-w3ls">
							<input id="pw"  placeholder="Password" Name="Password" type="password"  pattern=".{6,}"  
                             title="Tối thiểu 6 ký tự."	required="">
							<div class="icon-agile">
