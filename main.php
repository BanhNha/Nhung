...
<div class="topnav" id="myTopnav">
  ...
  <div class="dropdown">
	...
	<a id="no_remote" style="cursor: pointer">No remote</a>
    </div>
  </div> 
  <div class="dropdown">
...
<input type="text" id="input_name_room" placeholder="Enter Name" name="name_room" style="padding: 12px 25px;font-size:17px" required></span>
